...
export default function Challenges() {
  return (
    <div className="m-auto text-center max-w-[500px] border bg-[#333333] rounded-lg p-5 my-10">
      {/* Connect to wallet  */}
      ...
      <div>
        ...
        <div>
          <span className="font-semibold">Your Move:</span> <span>HIDDEN</span>
        </div>
        <div>Waiting for an opponent...</div>
        <button className="bg-blue-500 p-3 m-3 rounded-md text-white font-semibold">
          Update Challenges
        </button>
      </div>
    </div>
